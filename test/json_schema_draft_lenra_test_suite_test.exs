defmodule ExComponentSchema.JsonSchemaDraftLenraTestSuiteTest do
  ...
  use ExComponentSchema.Test.Support.TestSuiteTemplate,
    schema_tests_path: "test/API_component_test_suite/tests/",
    schema_url: "https://raw.githubusercontent.com/lenra-io/ex_component_schema/poc_components/priv/static/draft-lenra.json",
    ignored_tests: [
